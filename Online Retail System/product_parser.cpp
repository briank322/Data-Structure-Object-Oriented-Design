...
{
    Product* newbook = new Book(categoryID(),prodName_,price_,qty_,
        author_,isbn_);
    return newbook;
...
{
    Product* newcloth = new Clothing(categoryID(), prodName_,price_,qty_,
        size_,brand_);
    return newcloth;
...
{
   Product *newmovie = new Movie(categoryID(), prodName_,price_,qty_,
    genre_, rating_);
   return newmovie;
